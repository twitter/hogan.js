...
(function (Hogan) {
  ...
  function generate(tree, text, options) {
    ...
    return new Hogan.Template(new Function('cx', 'p', 'i', code), text, Hogan);
  }
  ...
  Hogan.compile = function(text, options) {
    ...
    t = generate(this.parse(this.scan(text, options.delimiters), options), text, options);
    return this.cache[text] = t;
  };
})(typeof exports !== 'undefined' ? exports : window.Hogan);