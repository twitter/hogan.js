    ...
    Hogan.scan = function scan(text, delimiters) {
        ...
        while( true ){
            ...
            if( i !== oI ){
                ...
                nI = tmpBuf.indexOf('\n');
                if( nI !== -1 ){
                    buf = tmpBuf.substring(0,nI);
                    filterLine(seenTag);
                    buf = tmpBuf.substring(nI + 1);
                }else
                    buf = tmpBuf;
                addBuf();
            }
            ...
            if( tagType === '=')
                ...
                tmpOTag = tagType === '{' ? '}' + ctag : ctag;

                cI = tagIndex( tmpOTag , text , i );
                ...
                tokens.push({
                    ...
                    otag: otag,
                    ctag: ctag,
                    i: (tagType === '/') ? seenTag - tmpOTag.length : cI + otag.length
                });
